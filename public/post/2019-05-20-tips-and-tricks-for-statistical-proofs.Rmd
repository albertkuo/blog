...
I've been taking measure-theoretic probability theory^[Our class used Durrett's [Probability Theory and Examples](https://services.math.duke.edu/~rtd/PTE/pte.html) textbook, if you were wondering.] this year and I noticed that a lot of proofs will assume that the reader already knows some commonly used "tricks." If you aren't familiar with them, it can be hard to prove it yourself or follow Durrett's proof at all. I felt like this was happening to me a lot, so in an effort to better familiarize myself with them, I've written down some useful tips and tricks.^[This guide was also inspired by Daniel Seita's [Mathematical Tricks Commonly Used in Machine Learning and Statistics](https://danieltakeshi.github.io/2017/05/06/mathematical-tricks-commonly-used-in-machine-learning-and-statistics).] They are arranged alphabetically below, with brief explanations and/or examples.
