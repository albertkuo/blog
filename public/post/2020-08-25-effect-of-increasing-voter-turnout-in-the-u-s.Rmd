...
4. **Generalizability to non-voting population**: I assume that the non-voting population votes exactly the same way as the voting population based on their demographics. 
