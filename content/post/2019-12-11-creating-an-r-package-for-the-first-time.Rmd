...
There are already a lot of great resources^[For example, [Hilary Parker's brief tutorial](https://hilaryparker.com/2014/04/29/writing-an-r-package-from-scratch/) or [Jeff Leek's guide](https://github.com/jtleek/rpackages) or [Karl Broman's tutorial](https://kbroman.org/pkg_primer/) or [Hadley Wickham's book](http://r-pkgs.had.co.nz/intro.html) (in increasing order of detail).] that teaches you how to make an R package. But I thought it would still be worthwhile to walk through how I created my first one -- at the very least, it'll be helpful for myself when I write my next R package.
...
To turn your R package into something more user-friendly, however, there are a couple more things you will want to do. One of them is to write tests for your R package to check for bugs and to "[dummy proof](https://github.com/jtleek/rpackages)" your functions. Another is to write vignettes to help people learn how to use your R package. Since these things go beyond what is strictly necessary for a functional R package,^[And it's also likely more than what I would be able to do in one day.] I will write about them in a later post.
